...
with open("outputs/preprocess0/inference/generics.json","r") as file:
  generics = json.load(file)
with open("outputs/preprocess0/inference/categories.json","r") as file:
...
import torch
import itertools
weights = torch.load("outputs/preprocess0/models/lr3e-04_lassoweight0e+00_batch256/epoch115.pt")["model"]["weight"]
