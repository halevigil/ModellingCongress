...
with open(os.path.join(args.d,"refinement_map.json"),"r") as file:
...
with open(os.path.join(args.d,"generics_dict_manual_llm_manual.json"),"w") as file:
  
  json.dump(generics_dict_manual_llm_manual,file)